                ...
                case 1:
                    ...
                    data.modules.forEach(function (m) {
                        ...
                        m.interfaces.forEach(function (i) { return __awaiter(_this, void 0, void 0, function () {
                            var url, id, name, description, method, requestTemplate, responseTemplate, params, response;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 2:
                                        ...
                                        params = mockjs2ts(requestTemplate.data);
...
function getRepository(endpoint, id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default(endpoint + "/repository/get?id=" + id)];
